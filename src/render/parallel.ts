...
import { tsxImportArgs } from "../util/tsx.js";
...
/** The worker is TypeScript, so the child needs a loader — see `tsxImportArgs`. */
const WORKER_EXEC_ARGV = WORKER_PATH.endsWith(".ts") ? tsxImportArgs() : [];
